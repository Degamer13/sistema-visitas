...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>{{ $visita->salida }}</td>
        <td>
            <a href="{{ route('visitas.show', $visita->id) }}" class="btn btn-info "><i class='fas fa-eye'></i></a>
            @can('visita-edit')
            <a href="{{ route('visitas.edit', $visita->id) }}" class="btn btn-primary "><i class='fas fa-pen'></i></a>
            @endcan
